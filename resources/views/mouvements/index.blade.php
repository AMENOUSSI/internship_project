...
@section('content')
    <div class="container mx-auto">
        ...
        <a href="{{ route('mouvements.create') }}" class="inline-flex items-center text-md px-3 py-2 mb-4  font-medium text-center text-gray-200 rounded-lg bg-blue-800 hover:bg-blue-900 focus:ring-4 focus:ring-primary-300 dark:bg-blue-900 dark:hover:bg-blue-950 dark:focus:ring-primary-800">
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 dark:bg-gray-700  font-playfair">
                <thead class="text-xs text-gray-200 uppercase bg-blue-800 dark:bg-blue-950 dark:text-gray-400">
                <tr>
                ...
                @foreach($mouvements as $mouvement)
                    <tr>
                        ...
                        <td class="py-2 px-4 flex text-center gap-1">
