{{--
<form action="{{ $action }}" method="POST" class="space-y-6 p-6 bg-white rounded-lg shadow-lg">
    @csrf
    @method($method)

    <!-- Client -->
    <div>
        <label for="client_id" class="block font-semibold text-gray-700 mb-1">Client :</label>
        <select name="client_id" id="client_id" required class="block w-full p-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-400">
    ...
    <!-- Assureur -->
    <div>
        <label for="assureur_id" class="block font-semibold text-gray-700 mb-1">Assureur :</label>
        <select name="assureur_id" id="assureur_id" required class="block w-full p-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-400">
    ...
    <!-- Affaire -->
    <div>
        <label for="affaire_id" class="block font-semibold text-gray-700 mb-1">Affaire :</label>
        <select name="affaire_id" id="affaire_id" required class="block w-full p-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-400">
    ...
    <!-- Assurance -->
    <div>
        <label for="assurance_id" class="block font-semibold text-gray-700 mb-1">Assurance :</label>
        <select name="assurance_id" id="assurance_id" required class="block w-full p-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-400">
    ...
    <!-- Date de Début -->
    <div>
        <label for="starting_date" class="block font-semibold text-gray-700 mb-1">Date de début :</label>
        <input type="datetime-local" name="starting_date" id="starting_date" required class="block w-full p-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-400" value="{{ old('starting_date', isset($police) ? \Carbon\Carbon::parse($police->starting_date)->format('Y-m-d\TH:i') : '') }}">
    </div>

    <!-- Date de Fin -->
    <div>
        <label for="ending_date" class="block font-semibold text-gray-700 mb-1">Date de fin :</label>
        <input type="datetime-local" name="ending_date" id="ending_date" class="block w-full p-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-400" value="{{ old('ending_date', isset($police) && $police->ending_date ? \Carbon\Carbon::parse($police->ending_date)->format('Y-m-d\TH:i') : '') }}">
    </div>

    <!-- Référence -->
    <div>
        <label for="reference" class="block font-semibold text-gray-700 mb-1">Référence :</label>
        <input type="text" name="reference" id="reference" maxlength="255" class="block w-full p-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-400" placeholder="Entrez la référence (facultatif)" value="{{ old('reference', isset($police) ? $police->reference : '') }}">
    </div>

    <!-- Bouton d'Envoi -->
    <div class="text-right">
        <button type="submit" class="bg-gradient-to-r from-blue-500 to-blue-900 text-white font-semibold px-6 py-2 rounded-lg shadow-md hover:from-green-500 hover:to-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-400">
...
<form action="{{ $action }}" method="POST" class="space-y-6 p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
    ...
    <!-- Référence -->
    <div>
        <label for="reference" class="block font-semibold text-gray-700 dark:text-gray-300 mb-1">Référence :</label>
        <input type="text" name="reference" id="reference" maxlength="255" class="block w-full p-3 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-400 dark:focus:ring-blue-500" placeholder="Entrez la référence (facultatif)" value="{{ old('reference', isset($police) ? $police->reference : '') }}">
    </div>
