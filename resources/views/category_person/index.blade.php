            ...
            @foreach ($categories as $category)
                <tr>
                    ...
                    <td class="py-2 px-4 border-b text-center">
                        ...
                        <a href="{{ route('category_people.edit', $category->id) }}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-blue-800 hover:bg-blue-900 focus:ring-4 focus:ring-primary-300 dark:bg-indigo-900 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
