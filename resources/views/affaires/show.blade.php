    ...
    <div class="max-w-4xl mx-auto py-8">
        <div class="bg-white shadow-md rounded-lg p-6">
            ...
            <div class="mb-4">
                ...
                <p class="text-gray-700">{{ $client->complete_name }}</p>
            </div>

            <div class="mb-4">
                <label class="font-semibold">Type de Client:</label>
                <p class="text-gray-700">{{ $client->type_client }}</p>
            </div>

            <div class="mb-4">
                <label class="font-semibold">Email:</label>
                <p class="text-gray-700">{{ $client->email ?? 'Non spécifié' }}</p>
            </div>

            <div class="mb-4">
                <label class="font-semibold">Date de Création:</label>
                <p class="text-gray-700">{{ $client->created_date }}</p>
            </div>
            ...
            <div class="mb-4">
                ...
                <p class="text-gray-700">{{ $client->birth_date }}</p>
            </div>
            ...
            <a href="{{ route('clients.index') }}" class="mt-6 inline-block px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600">
                Retour à la liste
            </a>
        </div>
    </div>
